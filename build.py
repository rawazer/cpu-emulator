...
def main():
    ...
    prg_crt_cmpl_res = subprocess.run(["gcc", DEFAULT_PROGRAM_CREATOR, "-o", "out/prg_creator.bin"])
    ...
    cpu_cmpl_res = subprocess.run(["gcc", "main.c", "cpu/cpu.c", "program_loader/program_loader.c", "-o", "out/cpu.bin"])
